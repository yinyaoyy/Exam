						...
						<div class="form" style="margin-top:20px;">
							...
							<form class="form-horizontal" id="form-create-account"
								...
								<div class="form-line form-department" style="display: block;">
									...
									<select id="department-input-select" class="df-input-narrow" style="height:32px;">
								...
								<div class="form-group">
									<!-- Buttons -->
									<div class="col-md-12">
										<button type="submit" class="btn reg" id="btn-reg">注册账号</button>
