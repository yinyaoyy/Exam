		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-7" id="login-info">
					<c:choose>
						<c:when
							test="${not empty sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.trueName}">
							<div id="login-info-user">

								<a
									href="user-detail/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.trueName}"
									id="system-info-account" target="_blank">${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.trueName}</a>
									...
									<c:forEach items="${examList }" var="item">
										<tr>
											...
											<td><span>${item.examName }</span> 
												...
												<a	href="<%=list[1]%>/exam/canYuLv/${item.examId }" target="_blank">参与率</a>
												<a	href="<%=list[1]%>/exam/tongGuoLv/${item.examId }" target="_blank">通过率</a>
												<a	href="<%=list[1]%>/exam/gaoFenBang/${item.examId }" target="_blank">高分榜</a></td>
