...
public class ExamServiceImpl implements ExamService {
	...
	@Override
	public List<ExamHistory> getUserExamHistListByExamId(int examId, String searchStr, String order, int limit, Page<ExamHistory> page,int depId,String submitOrder,String verifyOrder) {
		// TODO Auto-generated method stub
		return examMapper.getUserExamHistListByExamId(examId, searchStr, order, limit, page,depId,submitOrder,verifyOrder);
	}
	@Override
	...
	@Override
	public List<ExamHistory> gettongGuoLvByExamId(int examId) {
		// TODO Auto-generated method stub
		return examMapper.gettongGuoLvByExamId(examId);
	}
	@Override
	public List<ExamHistory> getgaoFenBangByExamId(int examId) {
		// TODO Auto-generated method stub
		return examMapper.getgaoFenBangByExamId(examId);
	}
	@Override
	public List<ExamHistory> getgaoFenBangListByExamId(int examId) {
		// TODO Auto-generated method stub
		return examMapper.getgaoFenBangListByExamId(examId);
	}
}
