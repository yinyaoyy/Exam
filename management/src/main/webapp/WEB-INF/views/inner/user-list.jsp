		...
		<div id="question-list">
			<div class="table-controller">
				...
				<div class="btn-group table-controller-item" style="float: left">
					<button class="btn btn-info btn-sm" id="add-user-modal-btn">
				...
				<tbody style="font-size:13px;">
					<c:forEach items="${userList }" var="item">
						<tr>
							...
							<td>
								<span class="r-update-btn btn-sm btn-success btn-padding" data-id="21321" data-depid="${item.depId }">修改</span>
								<span class="disable-btn btn-sm btn-danger btn-padding" data-id="${item.userId }"
								...
								<span class="r-reset-pwd-btn btn-sm btn-warning btn-padding" data-id="21321" data-depid="${item.depId }">密码</span>
								<c:choose>
