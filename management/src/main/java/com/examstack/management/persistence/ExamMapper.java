...
public interface ExamMapper {
	 ...
	 * @return
	 */
	public List<ExamHistory> getUserExamHistListByExamId(@Param("examId") int examId,@Param("searchStr") String searchStr,@Param("order") String order,@Param("limit") int limit,@Param("page") Page<ExamHistory> page,@Param("depId") int depId,@Param("submitOrder") String submitOrder,@Param("verifyOrder") String verifyOrder);
