...
public class ExamPageTeacher {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/teacher/exam/tongGuoLv/{examId}", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/teacher/exam/gaoFenBang/{examId}", method = RequestMethod.GET)
