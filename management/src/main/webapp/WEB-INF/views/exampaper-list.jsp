						...
						<div class="page-content">
							...
							<div id="question-list">
								<table class="table-striped table">
									<thead>
										<tr>
											<td></td><td>ID</td><td>试卷名称</td><td>时长</td><td>及格分</td><td>类别</td><td>创建人</td><td>状态</td><td>操作</td>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${paper }" var="item">
											<tr>
												<td>
													...
													<input class="paper-field" type="hidden" value="${item.field_id }">
												</td>
												<td>${item.id }</td>
												...
												<td>
													<c:choose>
														<c:when test="${item.status == 0 }">
															...
															<!-- <a class="change-property btn-sm btn-success" title="修改属性"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
														     ...
														     <div class="modal-body">
														     	<form id="question-add-form">
																	...
																	<div class="form-line add-update-exampaper-type">
																		...
																		<select id="exampaper-paperType-select" class="df-input-narrow">
