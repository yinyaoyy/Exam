...
public class ExamPaperActionTeacher {
	...
	@RequestMapping(value = "teacher/paper-update/{examPaperId}", method = RequestMethod.POST)
	public @ResponseBody
	Message updateByExampaper(@PathVariable("examPaperId") int examPaperId,@RequestBody PaperCreatorParam param) {
		...
		examPaper.setPass_point(param.getPassPoint());
		examPaper.setField_id(param.getPaperType());
		examPaper.setPaper_type(param.getType());
		examPaper.setId(examPaperId);
